    ...
    - complementary [ref=e5]:
      ...
      - navigation [ref=e12]:
        - button "Dashboard" [ref=e13]:
          - img [ref=e14]
          - text: Dashboard
        - button "Transfer Funds" [ref=e19]:
          - img [ref=e20]
          - text: Transfer Funds
        - button "Expense Tracker" [ref=e23]:
          - img [ref=e24]
          - text: Expense Tracker
        - button "Transactions" [ref=e27]:
          - img [ref=e28]
          - text: Transactions
        - button "AI Support" [ref=e32]:
          - img [ref=e33]
          - text: AI Support
      ...
      - generic [ref=e59]:
        ...
        - generic [ref=e96]:
          ...
          - generic [ref=e138]:
            ...
            - button "Quick Transfer" [ref=e180]
  - generic [ref=e181] [cursor=pointer]: $0k
```
...
```ts
  ...
  18 | 
  19 |     await page.pause(); //To Find elements using getByRole
  20 |     //Verify Initial Balance - $50,000.00
> 21 |     await expect(page.getByRole('heading', { name: '$50,000.00' }));
     |                                                           ^ Error: expect(locator).toHaveText(expected) failed
  22 | 
  23 |     //Navigate to Transfer Funds
  24 |     await page.getByRole('button', { name: 'Transfer Funds' }).click();
  25 | 
  26 |     // Fill in the Transfer Funds Form to Transfer $5000 to the account number 1234576890
  27 |     await page.getByPlaceholder('0.00').fill('5000');
  28 |     await page.getByPlaceholder('e.g. Rent for October').fill('Playwright Course Payment');
  29 |     await page.getByRole('button',{name:'Continue'}).click();
  30 | 
  31 |     //Click on Confirm Transfer
  32 |     await page.getByRole('button', {name:'Confirm Transfer'}).click();
  33 | 
  34 |     //Navigate to Dashboard and verify the Balance amount 
  35 |     await page.getByRole('button', { name: 'Dashboard' }).click();
  36 |     await expect(page.getByRole('heading', { name: '$45,000.00' }));
  37 | 
  38 |     //Logout from the TTA Bank
